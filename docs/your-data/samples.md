...
![Forty samples in the order of a tree, each a row of cells along the chromosome: one clade has a white cell where it lost a stretch, and three samples a dark one where they carry a stretch twice](../assets/start/heatmap.svg){ .k-light width="720" height="602" }
...
depth: a sample sequenced deeper is not a darker row, and what changed along
the genome is what stands out. Here one clade lost a stretch, and three
samples carry another twice. A table of windows does not say how long the
