...
-   [![An eight-panel synthetic atlas whose third panel is a curved tree with ancestral-state donuts on internal nodes, mutation symbols on branches and concordance whiskers](../assets/figures/example-evolutionary-surveillance.svg){ width="1408" height="2093" loading="lazy" }](../tracks/phylogeny.md#treetrack)
...
-   [![An eight-panel synthetic atlas whose last panel is an effective population size trajectory on a log scale with its uncertainty ribbon, above stacked lineage frequencies](../assets/figures/example-evolutionary-surveillance.svg){ width="1408" height="2093" loading="lazy" }](../tracks/evolution-surveillance.md#phylodynamictrack)
...
-   [![An eight-panel synthetic atlas whose last panel ends in stacked lineage frequencies by month, with markers where a lineage passed an alert](../assets/figures/example-evolutionary-surveillance.svg){ width="1408" height="2093" loading="lazy" }](../tracks/evolution-surveillance.md#surveillancetrack)
