...
-   [![A read depth profile over the rpoB locus with a dropout, above a reference band, the rpoB gene model and variant calls](../assets/figures/example.svg){ width="900" height="305" loading="lazy" }](../tracks/signal-sequence.md#coveragetrack)
...
-   [![pN/pS on a log2 scale and GC skew in windows along forty kilobases, each drawn either side of its own baseline, with the two sides of each line in different colours](../assets/figures/example-selection.svg){ width="880" height="233" loading="lazy" .k-wide }](../tracks/signal-sequence.md#windowtrack)
...
-   [![Sixty bases of the rpoB locus at base resolution: a depth profile, the reference drawn as coloured letters, and variant calls](../assets/figures/example-zoom.svg){ width="900" height="222" loading="lazy" .k-wide }](../tracks/signal-sequence.md#sequencetrack)
...
-   [![One eight-column DNA motif drawn three ways: as probabilities, as information in bits, and as enrichment above the line with depletion below it](../assets/figures/example-logo.svg){ width="900" height="379" loading="lazy" }](../tracks/signal-sequence.md#logotrack)
...
-   [![Four columns scored five ways against a background, as log odds, KL divergence, difference, ratio and odds ratio, each putting the emphasis on a different column](../assets/figures/example-logo-scores.svg){ width="760" height="543" loading="lazy" }](../tracks/signal-sequence.md#logotrack)
...
-   [![The same motif proportions from five, fifty and five hundred sequences, each drawn raw and shrunk: the raw logos look alike, while the shrunk ones grow with the number of sequences](../assets/figures/example-logo-stability.svg){ width="700" height="485" loading="lazy" }](../tracks/signal-sequence.md#logotrack)
...
-   [![A sequence logo whose symbols are three-letter amino acid codes](../assets/figures/example-logo-protein.svg){ width="640" height="205" loading="lazy" }](../tracks/signal-sequence.md#logotrack)
...
-   [![Junction arcs over an RNA depth profile with per-base model attribution beneath, and a close-up of a promoter motif where each base is a letter sized by its score, above or below the line](../assets/figures/example-regulation.svg){ width="811" height="788" loading="lazy" }](../tracks/signal-sequence.md#dynseqtrack)
