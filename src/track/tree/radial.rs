...
impl TraitDomain {
    pub(super) fn new<'a>(values: impl IntoIterator<Item = &'a AnnotationValue>) -> Self {
    ...
    pub(super) fn fraction(&self, value: Option<&AnnotationValue>) -> Option<f64> {
    ...
    pub(super) fn category(&self, value: Option<&AnnotationValue>) -> Option<usize> {
...
pub(super) fn binary_state(value: Option<&AnnotationValue>) -> Option<bool> {
    match value? {
