...
//! # Extending
//!
//! The seven track types shipped here are implementations of one small trait,
...
pub use crate::track::{
    Aggregate, AxisTrack, Centering, CigarOp, CoverageStyle, CoverageTrack, DrawContext, Feature,
    FeatureTrack, LogoColumn, LogoScore, LogoStack, LogoTrack, PileupLayout, PileupTrack, Read,
    ReadColoring, Rect, Segment, SequenceTrack, StackOrder, Strand, Track, Variant, VariantStyle,
    VariantTrack,
};
