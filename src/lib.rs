...
//! # Extending
//!
//! The twelve track types shipped here are implementations of one small trait,
...
pub use crate::track::{
    Aggregate, AlignmentBlock, Association, AxisTrack, Band, CellScale, Centering, CigarOp,
    ...
    Strand, SyntenyTrack, Track, Variant, VariantStyle, VariantTrack,
};
