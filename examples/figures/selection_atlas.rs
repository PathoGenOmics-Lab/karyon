//! The figure `cargo run --example selection_atlas` writes, as a function.
//!
...
use karyon::{
    AxisTrack, BranchRateMixture, Drawing, Feature, FeatureTrack, Figure, HomoplasyLayer, Panels,
    Region, SelectionEvidence, SelectionSite, SelectionTrack, Theme, TraitColumn, TreeTrack,
};

/// `example-selection-atlas.svg`: branch models, recurrent changes and site
/// scans on one sheet.
///
...
/// `region` are ignored.
pub fn example_selection_atlas(
    theme: &Theme,
    _width: Option<f64>,
